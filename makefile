output: main.o file_reader.o solutions.o day1.o day2.o day3.o day4.o day5.o day6.o
	gcc main.o file_reader.o day1.o day2.o day3.o day4.o day5.o day6.o -o output
